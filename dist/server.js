...
var trpcExpress = __importStar(require("@trpc/server/adapters/express")); // TRPC Express adapter for integrating TRPC with Express.
var trpc_1 = require("./trpc"); // The TRPC router instance defined in the trpc.ts file.
