...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        limit: zod_1.z.number().min(1).max(100), // Specifies how many products to fetch in a single request (limits to a range of 1 to 100)
        cursor: zod_1.z.number().nullish(), // Last element rendered; if user scrolls to get more products, it starts fetching the next page using this cursor
        query: query_validator_1.QueryValidator, // Custom validator for the query, ensuring only allowed options can be passed
    }))
        .query(function (_a) {
        var input = _a.input;
