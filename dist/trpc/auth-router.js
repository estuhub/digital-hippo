...
exports.authRouter = (0, trpc_1.router)({
    ...
    createPayloadUser: trpc_1.publicProcedure
        .input(account_credentials_validators_1.AuthCredentialsValidator) // Input validation using Zod schema
    ...
    verifyEmail: trpc_1.publicProcedure
        .input(zod_1.z.object({ token: zod_1.z.string() })) // Input validation using Zod schema
        .query(function (_a) {
        var input = _a.input;
        return __awaiter(void 0, void 0, void 0, function () {
